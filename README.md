...
'train'). There are 1314 training images and 194 test images divided into two categories, with and without mask.
...
```
git clone https://github.com/Dalinoinasatish5/FaceMaskDetector.git
```
followed by:
...
2. Download all libraries using:
```
